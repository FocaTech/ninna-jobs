...
urlpatterns = [
    ...
    path('bash', views.buscas, name='bash'),#busca de dashboard candidatos
    path('bempresa', views.buscas, name='bempresa'),#busca da dashboard empresa
    path('bcand', views.buscas, name='bcand'),#busca do admin de todos os candidatos
    path('badmin', views.buscas, name='badmin'),#busca do admin em admins
    path('BVadmin', views.buscas, name='BVadmin'),#busca do admin em vagas
    path('BAempresa', views.buscas, name='BAempresa'),#busca do admin em vagas
